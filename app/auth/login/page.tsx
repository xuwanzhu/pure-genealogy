  ...
  return (
    <div className="relative flex min-h-svh w-full flex-col items-center justify-center p-6 md:p-10 overflow-hidden bg-background">
      ...
      <div className="mb-8 flex flex-col items-center gap-4 z-10 animate-rise">
        <div className="glow-primary flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-cyan-500 text-2xl font-bold text-white shadow-lg rotate-[-4deg] hover:rotate-0 transition-transform duration-300">
